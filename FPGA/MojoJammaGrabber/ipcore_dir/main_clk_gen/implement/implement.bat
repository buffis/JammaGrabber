...
xst -ifn xst.scr
move main_clk_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\main_clk_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc main_clk_gen_exdes.ucf main_clk_gen_exdes

echo 'Running map'
map -timing -pr b main_clk_gen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm main_clk_gen_exdes -w routed.ncd routed.v
cd ..
